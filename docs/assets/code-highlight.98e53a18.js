import{_ as M,a as U,b as F,c as V,d as Y,e as z}from"./SearchBlock.1e4291ad.js";import{_ as G}from"./client-only.bc1de542.js";import{f as X,h as K,j as Q,r as k,k as l,g as Z,l as ss,c as ns,u as s,m as j,b as R,w as as,n as ts,o as d}from"./entry.02ff2795.js";import{u as es}from"./vue.f36acd1f.eda93068.js";import{d as ls}from"./docs.code-highlight.config.a1eae79e.js";import"./nuxt-link.162a37af.js";import"./OpenApiDropdown.42b99cd0.js";const o={openapi:"3.0.0",info:{title:"Syntax Highlighting",version:"1.0.0",description:`<p>You may provide little snippets of code using markdown syntax and they will be color coded based on the language you specified as shown below</p>
<pre><code>    \`\`\`java
      some code...
      ...
      ...
...
`,content:{"application/json":{schema:"#/components/schemas/Price"}}},responses:{200:{description:"Successful"}},tags:["other"]}}},components:{schemas:{Price:{type:"object",properties:{amount:{type:"integer"},currency:{type:"string"}}}}},tags:{}},os={class:"content-container"},gs=X({__name:"code-highlight",setup(ps){const m=K(),I=Q(),{$openapidoc:f,$openapidocBus:v,$openapidocRef:y}=ts(),q=k(""),T=k(0),_=k(ls.path.toString()),c=k(o??{}),g=l(()=>"code-highlight"),e=l(()=>m.params.type.toString()),O=l(()=>(m.params.mathod??"default").toString()),x=l(()=>e.value==="info"),S=l(()=>e.value==="auth"),P=l(()=>e.value==="components"),h=l(()=>f.currentLocale());y.setComponents(o.components),y.setDefinitions(o.definitions),y.setDocPath(_.value),y.setFile(g.value);const p=l(()=>{const n={...o.paths};if(!n)return null;for(const t in n){let a=t.toString();if(a.startsWith("/")&&(a=a.substring(1)),a.endsWith("/")&&(a=a.substring(-1)),a.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),a===O.value)return q.value=t.toString(),n[t]??null}return null}),r=l(()=>{const n={...o.webhooks};if(!n)return null;for(const t in n){let a=t.toString();if(a.startsWith("/")&&(a=a.substring(1)),a.endsWith("/")&&(a=a.substring(-1)),a.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),a===O.value)return q.value=t.toString(),n[t][e.value]??null}return null}),i=l(()=>p.value?p.value[e.value]??null:null),A=l(()=>p.value?p.value.parameters??null:null),N=l(()=>{const n=f.currentLocale()??"";return x.value?"[code-highlight] - Info Docs":S.value?"[code-highlight] - Authorization":P.value?"[code-highlight] - Components Docs":i.value?"[code-highlight] - "+(i.value["x-summary-"+n.value]||i.value.summary||""):""}),E=l(()=>{const n=f.currentLocale()??"";return x.value?"[code-highlight] - Info Docs":S.value?"[code-highlight] - Authorization":P.value?"[code-highlight] - Components Docs":i.value&&(i.value["x-description-"+n.value]||i.value.description)||""});es({title:N.value,meta:[{name:"description",content:E.value}],htmlAttrs:{lang:h.value},bodyAttrs:{class:"oapi"}});const C=l(()=>{if(p.value){if(p.value.servers&&p.value.servers[0])return p.value.servers[0].url??null;if(p.value[e.value]&&p.value[e.value].servers&&p.value[e.value].servers[0])return p.value[e.value].servers[0].url??null}if(r.value){if(r.value.servers&&r.value.servers[0])return r.value.servers[0].url??null;if(r.value[e.value]&&r.value[e.value].servers&&r.value[e.value].servers[0])return r.value[e.value].servers[0].url??null}let n=T.value;if(n>0&&o.servers&&!o.servers[n]&&(n=0),!o.servers||!o.servers[n])return"";if(o.servers[n].variables){const t=Object.values(o.servers[n].variables)??[];if(t&&t.length)return t[0].default}return o.servers[n].url??""});function H(n){T.value=n}function D(){var t;(((t=document.querySelector(".content-container"))==null?void 0:t.querySelectorAll("h1[id], h2[id], h3[id], h4[id]"))??[]).forEach(a=>{a.addEventListener("click",u=>{const b=a.getAttribute("id"),w=window.location.origin+window.location.pathname+"#"+b;f.copyToClipboard(w,u,!1),I.push({path:m.path,hash:"#"+b}),setTimeout(()=>{a.scrollIntoView({behavior:"smooth",block:"start"})},100)})})}function $(){if(m.hash)return;const n=document.querySelector(".oapi-content");n&&(n.scrollTop=0)}function L(){const n=JSON.stringify(o,null,4),t=new Blob([n],{type:"application/json"}),a=URL.createObjectURL(t),u=document.createElement("a");u.href=a,u.download=g.value+".json",document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(a)}return Z(()=>{v.$on("downloadJsonDoc",L),v.$on("changeServer",H),$(),D()}),ss(()=>{v.$off("downloadJsonDoc",L),v.$off("changeServer",H)}),(n,t)=>{const a=M,u=U,b=F,w=V,B=z,W=Y,J=G;return d(),ns("div",os,[s(x)&&s(c).info?(d(),j(a,{key:0,info:s(c).info,servers:s(c).servers,"current-locale":s(h)},null,8,["info","servers","current-locale"])):s(S)&&s(c).components?(d(),j(u,{key:1,components:s(c).components,"current-locale":s(h)},null,8,["components","current-locale"])):s(P)&&s(c).components?(d(),j(b,{key:2,components:s(c).components,"current-locale":s(h)},null,8,["components","current-locale"])):s(i)?(d(),j(w,{key:3,route:s(i),"current-locale":s(h),method:s(e),components:s(c).components,url:s(q),path_doc:s(_),file:s(g),server:s(C),"sub-params":s(A)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):s(r)?(d(),j(w,{key:4,route:s(r),"current-locale":s(h),method:s(e),components:s(c).components,url:s(q),path_doc:s(_),file:s(g),server:s(C),"sub-params":s(A)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):(d(),j(B,{key:5})),R(J,null,{default:as(()=>[R(W,{"current-locale":s(h),doc:s(c),path:s(_),file:s(g)},null,8,["current-locale","doc","path","file"])]),_:1})])}}});export{gs as default};
