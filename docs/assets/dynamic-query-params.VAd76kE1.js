import{_ as N,a as J,b as T,c as W,d as Q,e as H}from"./SearchBlock.zjbCsXBR.js";import{_ as M}from"./client-only.gNT5aGZS.js";import{f as K,h as X,j as Y,r as A,k as l,g as Z,l as ss,c as as,u as s,m as d,b as U,w as ns,n as es,o as m}from"./entry.tMswm5PA.js";import{u as ts}from"./vue.f36acd1f.S-4yh9PD.js";import{d as ls}from"./docs.dynamic-query-params.config.Wpk_cJO0.js";import"./nuxt-link.o_QJ7VHF.js";import"./OpenApiDropdown.o3VUtLxc.js";const r={openapi:"3.0.0",info:{title:"Dynamic Query Params",version:"1.0.0"},paths:{"/dynamic-query-params":{get:{tags:["Query Params"],summary:"Various ways to pass query params",description:`<p>Following OpenAPI spec demonstrate various ways to pass query params.</p>
<ul>
...
`,schema:{type:"object",properties:{someProperty:{type:"string"}},additionalProperties:{type:"string"}}}}},{in:"query",name:"dynamic-query-params5",description:"Example generation works for non-exloded objects:&lt;br /&gt; `propertyOne=VALUE-1&property2=FLAG-1`\n",explode:!1,required:!1,schema:{type:"object",properties:{propertyOne:{type:"string",enum:["VALUE-1","VALUE-2"],default:"VALUE-2"},propertyTwo:{type:"string",enum:["FLAG-1","FLAG-2"],default:"FLAG-1"}}}}],responses:{200:{description:"successful operation"}}}}},tags:{}},rs={class:"content-container"},js=K({__name:"dynamic-query-params",setup(ps){const y=X(),V=Y(),{$openapidoc:g,$openapidocBus:f,$openapidocRef:v}=es(),q=A(""),L=A(0),b=A(ls.path.toString()),o=A(r??{}),j=l(()=>"dynamic-query-params"),t=l(()=>y.params.type.toString()),S=l(()=>(y.params.mathod??"default").toString()),k=l(()=>t.value==="info"),w=l(()=>t.value==="auth"),P=l(()=>t.value==="components"),h=l(()=>g.currentLocale());v.setComponents(r.components),v.setDefinitions(r.definitions),v.setDocPath(b.value),v.setFile(j.value);const p=l(()=>{const n={...r.paths};if(!n)return null;for(const e in n){let a=e.toString();if(a.startsWith("/")&&(a=a.substring(1)),a.endsWith("/")&&(a=a.substring(-1)),a=a.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),a===S.value)return q.value=e.toString(),n[e]??null}return null}),c=l(()=>{const n={...r.webhooks};if(!n)return null;for(const e in n){let a=e.toString();if(a.startsWith("/")&&(a=a.substring(1)),a.endsWith("/")&&(a=a.substring(-1)),a=a.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),a===S.value)return q.value=e.toString(),n[e][t.value]??null}return null}),u=l(()=>p.value?p.value[t.value]??null:null),C=l(()=>p.value?p.value.parameters??null:null),F=l(()=>{const n=g.currentLocale()??"";return k.value?"[dynamic-query-params] - Info Docs":w.value?"[dynamic-query-params] - Authorization":P.value?"[dynamic-query-params] - Components Docs":u.value?"[dynamic-query-params] - "+(u.value["x-summary-"+n.value]||u.value.summary||""):""}),R=l(()=>{const n=g.currentLocale()??"";return k.value?"[dynamic-query-params] - Info Docs":w.value?"[dynamic-query-params] - Authorization":P.value?"[dynamic-query-params] - Components Docs":u.value&&(u.value["x-description-"+n.value]||u.value.description)||""});ts({title:F.value,meta:[{name:"description",content:R.value}],htmlAttrs:{lang:h.value},bodyAttrs:{class:"oapi"}});const O=l(()=>{if(p.value){if(p.value.servers&&p.value.servers[0])return p.value.servers[0].url??null;if(p.value[t.value]&&p.value[t.value].servers&&p.value[t.value].servers[0])return p.value[t.value].servers[0].url??null}if(c.value){if(c.value.servers&&c.value.servers[0])return c.value.servers[0].url??null;if(c.value[t.value]&&c.value[t.value].servers&&c.value[t.value].servers[0])return c.value[t.value].servers[0].url??null}let n=L.value;if(n>0&&r.servers&&!r.servers[n]&&(n=0),!r.servers||!r.servers[n])return"";if(r.servers[n].variables){const e=Object.values(r.servers[n].variables)??[];if(e&&e.length)return e[0].default}return r.servers[n].url??""});function D(n){L.value=n}function z(){var e;(((e=document.querySelector(".content-container"))==null?void 0:e.querySelectorAll("h1[id], h2[id], h3[id], h4[id]"))??[]).forEach(a=>{a.addEventListener("click",i=>{const _=a.getAttribute("id"),x=window.location.origin+window.location.pathname+"#"+_;g.copyToClipboard(x,i,!1),V.push({path:y.path,hash:"#"+_}),setTimeout(()=>{a.scrollIntoView({behavior:"smooth",block:"start"})},100)})})}function $(){if(y.hash)return;const n=document.querySelector(".oapi-content");n&&(n.scrollTop=0)}function E(){const n=JSON.stringify(r,null,4),e=new Blob([n],{type:"application/json"}),a=URL.createObjectURL(e),i=document.createElement("a");i.href=a,i.download=j.value+".json",document.body.appendChild(i),i.click(),document.body.removeChild(i),URL.revokeObjectURL(a)}return Z(()=>{f.$on("downloadJsonDoc",E),f.$on("changeServer",D),$(),z()}),ss(()=>{f.$off("downloadJsonDoc",E),f.$off("changeServer",D)}),(n,e)=>{const a=N,i=J,_=T,x=W,B=H,G=Q,I=M;return m(),as("div",rs,[s(k)&&s(o).info?(m(),d(a,{key:0,info:s(o).info,servers:s(o).servers,"current-locale":s(h)},null,8,["info","servers","current-locale"])):s(w)&&s(o).components?(m(),d(i,{key:1,components:s(o).components,"current-locale":s(h)},null,8,["components","current-locale"])):s(P)&&s(o).components?(m(),d(_,{key:2,components:s(o).components,"current-locale":s(h)},null,8,["components","current-locale"])):s(u)?(m(),d(x,{key:3,route:s(u),"current-locale":s(h),method:s(t),components:s(o).components,url:s(q),path_doc:s(b),file:s(j),server:s(O),"sub-params":s(C)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):s(c)?(m(),d(x,{key:4,route:s(c),"current-locale":s(h),method:s(t),components:s(o).components,url:s(q),path_doc:s(b),file:s(j),server:s(O),"sub-params":s(C)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):(m(),d(B,{key:5})),U(I,null,{default:ns(()=>[U(G,{"current-locale":s(h),doc:s(o),path:s(b),file:s(j)},null,8,["current-locale","doc","path","file"])]),_:1})])}}});export{js as default};
