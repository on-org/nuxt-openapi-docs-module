import{_ as $,a as J,b as W,c as z,d as E,e as V}from"./BdpLcoxu.js";import{_ as X}from"./BXvlvvPw.js";import{f as G,h as K,j as Q,r as x,k as a,g as Y,l as Z,c as ee,u as e,m,b as A,w as te,n as ne,o as d}from"./qEcSDZDN.js";import{u as oe}from"./Nl5E_vvB.js";import{d as re}from"./BvYXFt5L.js";import"./DwPOiaZ-.js";import"./BykPuthJ.js";const i={openapi:"3.0.0",info:{title:"Markdown Content",description:"Test case to show markdown support. For more info check specification (http://spec.openapis.org/oas/v3.0.3)",version:"1.0.0"},paths:{"/markdown":{get:{summary:"Markdown in Description.",description:`<p>Endpoint to create and initiate a pipeline.</p>
<h3>Paragraph</h3>
...
`}}}},tags:["other"]}}},tags:{}},ae={class:"content-container"},he=G({__name:"markdown",setup(se){const h=K(),D=Q(),{$openapidoc:f,$openapidocBus:I,$openapidocRef:g}=ne(),v=x(""),S=x(0),b=x((re.path??"").toString()),l=x(i??{}),_=a(()=>"markdown"),r=a(()=>h.params.type.toString()),T=a(()=>(h.params.mathod??"default").toString()),w=a(()=>r.value==="info"),q=a(()=>r.value==="auth"),N=a(()=>r.value==="components"),p=a(()=>f.currentLocale());g.setComponents(i.components),g.setDefinitions(i.definitions),g.setDocPath(b.value),g.setFile(_.value);const s=a(()=>{const t={...i.paths};if(!t)return null;for(const o in t){let n=o.toString();if(n.startsWith("/")&&(n=n.substring(1)),n.endsWith("/")&&(n=n.substring(-1)),n=n.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),n===T.value)return v.value=o.toString(),t[o]??null}return null}),c=a(()=>{const t={...i.webhooks};if(!t)return null;for(const o in t){let n=o.toString();if(n.startsWith("/")&&(n=n.substring(1)),n.endsWith("/")&&(n=n.substring(-1)),n=n.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),n===T.value)return v.value=o.toString(),t[o][r.value]??null}return null}),u=a(()=>s.value?s.value[r.value]??null:null),C=a(()=>s.value?s.value.parameters??null:null),H=a(()=>{const t=f.currentLocale()??"";return w.value?"[markdown] - Info Docs":q.value?"[markdown] - Authorization":N.value?"[markdown] - Components Docs":u.value?"[markdown] - "+(u.value["x-summary-"+t.value]||u.value.summary||""):""}),F=a(()=>{const t=f.currentLocale()??"";return w.value?"[markdown] - Info Docs":q.value?"[markdown] - Authorization":N.value?"[markdown] - Components Docs":u.value&&(u.value["x-description-"+t.value]||u.value.description)||""});oe({title:H.value,meta:[{name:"description",content:F.value}],htmlAttrs:{lang:p.value},bodyAttrs:{class:"oapi"}});const P=a(()=>{if(s.value){if(s.value.servers&&s.value.servers[0])return s.value.servers[0].url??null;if(s.value[r.value]&&s.value[r.value].servers&&s.value[r.value].servers[0])return s.value[r.value].servers[0].url??null}if(c.value){if(c.value.servers&&c.value.servers[0])return c.value.servers[0].url??null;if(c.value[r.value]&&c.value[r.value].servers&&c.value[r.value].servers[0])return c.value[r.value].servers[0].url??null}let t=S.value;if(t>0&&i.servers&&!i.servers[t]&&(t=0),!i.servers||!i.servers[t])return"";if(i.servers[t].variables){const o=Object.values(i.servers[t].variables)??[];if(o&&o.length)return o[0].default}return i.servers[t].url??""});function R(t){S.value=t}function M(){var o;(((o=document.querySelector(".content-container"))==null?void 0:o.querySelectorAll("h1[id], h2[id], h3[id], h4[id]"))??[]).forEach(n=>{n.addEventListener("click",L=>{const y=n.getAttribute("id"),k=window.location.origin+window.location.pathname+"#"+y;f.copyToClipboard(k,L,!1),D.push({path:h.path,hash:"#"+y}),setTimeout(()=>{n.scrollIntoView({behavior:"smooth",block:"start"})},100)})})}function O(){if(h.hash)return;const t=document.querySelector(".oapi-content");t&&(t.scrollTop=0)}return Y(()=>{I.$on("changeServer",R),O(),M()}),Z(()=>{I.$off("changeServer",R)}),(t,o)=>{const n=$,L=J,y=W,k=z,j=V,B=E,U=X;return d(),ee("div",ae,[e(w)&&e(l).info?(d(),m(n,{key:0,info:e(l).info,servers:e(l).servers,"current-locale":e(p)},null,8,["info","servers","current-locale"])):e(q)&&e(l).components?(d(),m(L,{key:1,components:e(l).components,"current-locale":e(p)},null,8,["components","current-locale"])):e(N)&&e(l).components?(d(),m(y,{key:2,components:e(l).components,"current-locale":e(p)},null,8,["components","current-locale"])):e(u)?(d(),m(k,{key:3,route:e(u),"current-locale":e(p),method:e(r),components:e(l).components,url:e(v),path_doc:e(b),file:e(_),server:e(P),"sub-params":e(C)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):e(c)?(d(),m(k,{key:4,route:e(c),"current-locale":e(p),method:e(r),components:e(l).components,url:e(v),path_doc:e(b),file:e(_),server:e(P),"sub-params":e(C)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):(d(),m(j,{key:5})),A(U,null,{default:te(()=>[A(B,{"current-locale":e(p),doc:e(l),path:e(b),file:e(_)},null,8,["current-locale","doc","path","file"])]),_:1})])}}});export{he as default};
