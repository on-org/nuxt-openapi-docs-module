import{_ as $,a as W,b as F,c as G,d as V,e as z}from"./CBkLy2SA.js";import{_ as J}from"./B3LdbQa4.js";import{f as Y,h as K,j as Q,r as w,k as r,g as X,l as Z,c as ee,u as e,m,b as N,w as te,n as ne,o as d}from"./BahJtFiW.js";import{u as oe}from"./Di5kSJuz.js";import{d as se}from"./_VurbN1F.js";import"./cp20_NM7.js";import"./CmtHmwLK.js";const i={openapi:"3.0.2",info:{title:"Links",version:"1.0",description:`<h1>Various ways to create links in RapiDoc</h1>
<ul>
...
`,properties:{page:{description:"Current Page number",type:"integer"},per_page:{description:"Number of records per page",type:"integer"},total:{description:"Total number of records",type:"integer"},total_pages:{type:"integer"},data:{type:"array",description:"List of users",items:"#/components/schemas/user"},support:"#/components/schemas/support"}}}}}},tags:["other"]},post:{description:"Create a user",requestBody:{content:{"application/json":{schema:"#/components/schemas/userInput"}}},responses:{201:{description:"User creation response",content:{"application/json":{schema:{allOf:["#/components/schemas/userInput","#/components/schemas/createUserResponse"]}}}}},tags:["other"]}},"/users/{userId}":{get:{description:"Get a Single User",parameters:[{in:"path",name:"userId",schema:{type:"integer",example:3},required:!0,description:"Numeric ID of the user to get"}],responses:{200:{description:"Response when a user is found",content:{"application/json":{schema:{type:"object",properties:{data:"#/components/schemas/user",support:"#/components/schemas/support"}}}}},404:{description:"User Not found"}},tags:["other"]}}},components:{schemas:{user:{type:"object",properties:{id:{description:"User ID",type:"integer"},email:{description:"User Email",type:"string"},first_name:{description:"First Name",type:"string"},last_name:{description:"Last Name",type:"string"},avatar:{description:"Avatar URL",type:"string"}}},support:{type:"object",properties:{url:{description:"Support URL",type:"string"},text:{description:"Support URL - Description",type:"string"}}},userInput:{type:"object",properties:{name:{description:"User Name",type:"string"},job:{description:"Job",type:"string"}}},createUserResponse:{type:"object",properties:{id:{type:"integer"},createdAt:{type:"string"}}}}},tags:{}},re={class:"content-container"},he=Y({__name:"links",setup(ae){const h=K(),j=Q(),{$openapidoc:v,$openapidocBus:S,$openapidocRef:g}=ne(),f=w(""),R=w(0),y=w((se.path??"").toString()),c=w(i??{}),_=r(()=>"links"),s=r(()=>h.params.type.toString()),A=r(()=>(h.params.mathod??"default").toString()),x=r(()=>s.value==="info"),D=r(()=>s.value==="auth"),I=r(()=>s.value==="components"),p=r(()=>v.currentLocale());g.setComponents(i.components),g.setDefinitions(i.definitions),g.setDocPath(y.value),g.setFile(_.value);const a=r(()=>{const t={...i.paths};if(!t)return null;for(const o in t){let n=o.toString();if(n.startsWith("/")&&(n=n.substring(1)),n.endsWith("/")&&(n=n.substring(-1)),n=n.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),n===A.value)return f.value=o.toString(),t[o]??null}return null}),l=r(()=>{const t={...i.webhooks};if(!t)return null;for(const o in t){let n=o.toString();if(n.startsWith("/")&&(n=n.substring(1)),n.endsWith("/")&&(n=n.substring(-1)),n=n.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),n===A.value)return f.value=o.toString(),t[o][s.value]??null}return null}),u=r(()=>a.value?a.value[s.value]??null:null),U=r(()=>a.value?a.value.parameters??null:null),C=r(()=>{const t=v.currentLocale()??"";return x.value?"[links] - Info Docs":D.value?"[links] - Authorization":I.value?"[links] - Components Docs":u.value?"[links] - "+(u.value["x-summary-"+t.value]||u.value.summary||""):""}),P=r(()=>{const t=v.currentLocale()??"";return x.value?"[links] - Info Docs":D.value?"[links] - Authorization":I.value?"[links] - Components Docs":u.value&&(u.value["x-description-"+t.value]||u.value.description)||""});oe({title:C.value,meta:[{name:"description",content:P.value}],htmlAttrs:{lang:p.value},bodyAttrs:{class:"oapi"}});const T=r(()=>{if(a.value){if(a.value.servers&&a.value.servers[0])return a.value.servers[0].url??null;if(a.value[s.value]&&a.value[s.value].servers&&a.value[s.value].servers[0])return a.value[s.value].servers[0].url??null}if(l.value){if(l.value.servers&&l.value.servers[0])return l.value.servers[0].url??null;if(l.value[s.value]&&l.value[s.value].servers&&l.value[s.value].servers[0])return l.value[s.value].servers[0].url??null}let t=R.value;if(t>0&&i.servers&&!i.servers[t]&&(t=0),!i.servers||!i.servers[t])return"";if(i.servers[t].variables){const o=Object.values(i.servers[t].variables)??[];if(o&&o.length)return o[0].default}return i.servers[t].url??""});function q(t){R.value=t}function H(){var o;(((o=document.querySelector(".content-container"))==null?void 0:o.querySelectorAll("h1[id], h2[id], h3[id], h4[id]"))??[]).forEach(n=>{n.addEventListener("click",L=>{const b=n.getAttribute("id"),k=window.location.origin+window.location.pathname+"#"+b;v.copyToClipboard(k,L,!1),j.push({path:h.path,hash:"#"+b}),setTimeout(()=>{n.scrollIntoView({behavior:"smooth",block:"start"})},100)})})}function M(){if(h.hash)return;const t=document.querySelector(".oapi-content");t&&(t.scrollTop=0)}return X(()=>{S.$on("changeServer",q),M(),H()}),Z(()=>{S.$off("changeServer",q)}),(t,o)=>{const n=$,L=W,b=F,k=G,O=z,B=V,E=J;return d(),ee("div",re,[e(x)&&e(c).info?(d(),m(n,{key:0,info:e(c).info,servers:e(c).servers,"current-locale":e(p)},null,8,["info","servers","current-locale"])):e(D)&&e(c).components?(d(),m(L,{key:1,components:e(c).components,"current-locale":e(p)},null,8,["components","current-locale"])):e(I)&&e(c).components?(d(),m(b,{key:2,components:e(c).components,"current-locale":e(p)},null,8,["components","current-locale"])):e(u)?(d(),m(k,{key:3,route:e(u),"current-locale":e(p),method:e(s),components:e(c).components,url:e(f),path_doc:e(y),file:e(_),server:e(T),"sub-params":e(U)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):e(l)?(d(),m(k,{key:4,route:e(l),"current-locale":e(p),method:e(s),components:e(c).components,url:e(f),path_doc:e(y),file:e(_),server:e(T),"sub-params":e(U)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):(d(),m(O,{key:5})),N(E,null,{default:te(()=>[N(B,{"current-locale":e(p),doc:e(c),path:e(y),file:e(_)},null,8,["current-locale","doc","path","file"])]),_:1})])}}});export{he as default};
