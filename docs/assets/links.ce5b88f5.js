import{_ as J,a as W,b as F,c as G,d as V,e as z}from"./SearchBlock.1e4291ad.js";import{_ as Y}from"./client-only.bc1de542.js";import{f as K,h as Q,j as X,r as x,k as a,g as Z,l as ee,c as ne,u as e,m,b as q,w as te,n as se,o as h}from"./entry.02ff2795.js";import{u as oe}from"./vue.f36acd1f.eda93068.js";import{d as ae}from"./docs.links.config.ada06c60.js";import"./nuxt-link.162a37af.js";import"./OpenApiDropdown.42b99cd0.js";const r={openapi:"3.0.2",info:{title:"Links",version:"1.0",description:`<h1 id="various-ways-to-create-links-in-rapidoc">Various ways to create links in RapiDoc</h1>
<ul>
...
`,properties:{page:{description:"Current Page number",type:"integer"},per_page:{description:"Number of records per page",type:"integer"},total:{description:"Total number of records",type:"integer"},total_pages:{type:"integer"},data:{type:"array",description:"List of users",items:"#/components/schemas/user"},support:"#/components/schemas/support"}}}}}},tags:["other"]},post:{description:"Create a user",requestBody:{content:{"application/json":{schema:"#/components/schemas/userInput"}}},responses:{201:{description:"User creation response",content:{"application/json":{schema:{allOf:["#/components/schemas/userInput","#/components/schemas/createUserResponse"]}}}}},tags:["other"]}},"/users/{userId}":{get:{description:"Get a Single User",parameters:[{in:"path",name:"userId",schema:{type:"integer",example:3},required:!0,description:"Numeric ID of the user to get"}],responses:{200:{description:"Response when a user is found",content:{"application/json":{schema:{type:"object",properties:{data:"#/components/schemas/user",support:"#/components/schemas/support"}}}}},404:{description:"User Not found"}},tags:["other"]}}},components:{schemas:{user:{type:"object",properties:{id:{description:"User ID",type:"integer"},email:{description:"User Email",type:"string"},first_name:{description:"First Name",type:"string"},last_name:{description:"Last Name",type:"string"},avatar:{description:"Avatar URL",type:"string"}}},support:{type:"object",properties:{url:{description:"Support URL",type:"string"},text:{description:"Support URL - Description",type:"string"}}},userInput:{type:"object",properties:{name:{description:"User Name",type:"string"},job:{description:"Job",type:"string"}}},createUserResponse:{type:"object",properties:{id:{type:"integer"},createdAt:{type:"string"}}}}},tags:{}},re={class:"content-container"},ge=K({__name:"links",setup(le){const v=Q(),C=X(),{$openapidoc:f,$openapidocBus:y,$openapidocRef:b}=se(),k=x(""),I=x(0),_=x(ae.path.toString()),c=x(r??{}),g=a(()=>"links"),o=a(()=>v.params.type.toString()),R=a(()=>(v.params.mathod??"default").toString()),D=a(()=>o.value==="info"),L=a(()=>o.value==="auth"),S=a(()=>o.value==="components"),d=a(()=>f.currentLocale());b.setComponents(r.components),b.setDefinitions(r.definitions),b.setDocPath(_.value),b.setFile(g.value);const l=a(()=>{const n={...r.paths};if(!n)return null;for(const s in n){let t=s.toString();if(t.startsWith("/")&&(t=t.substring(1)),t.endsWith("/")&&(t=t.substring(-1)),t.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),t===R.value)return k.value=s.toString(),n[s]??null}return null}),i=a(()=>{const n={...r.webhooks};if(!n)return null;for(const s in n){let t=s.toString();if(t.startsWith("/")&&(t=t.substring(1)),t.endsWith("/")&&(t=t.substring(-1)),t.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),t===R.value)return k.value=s.toString(),n[s][o.value]??null}return null}),u=a(()=>l.value?l.value[o.value]??null:null),U=a(()=>l.value?l.value.parameters??null:null),O=a(()=>{const n=f.currentLocale()??"";return D.value?"[links] - Info Docs":L.value?"[links] - Authorization":S.value?"[links] - Components Docs":u.value?"[links] - "+(u.value["x-summary-"+n.value]||u.value.summary||""):""}),P=a(()=>{const n=f.currentLocale()??"";return D.value?"[links] - Info Docs":L.value?"[links] - Authorization":S.value?"[links] - Components Docs":u.value&&(u.value["x-description-"+n.value]||u.value.description)||""});oe({title:O.value,meta:[{name:"description",content:P.value}],htmlAttrs:{lang:d.value},bodyAttrs:{class:"oapi"}});const A=a(()=>{if(l.value){if(l.value.servers&&l.value.servers[0])return l.value.servers[0].url??null;if(l.value[o.value]&&l.value[o.value].servers&&l.value[o.value].servers[0])return l.value[o.value].servers[0].url??null}if(i.value){if(i.value.servers&&i.value.servers[0])return i.value.servers[0].url??null;if(i.value[o.value]&&i.value[o.value].servers&&i.value[o.value].servers[0])return i.value[o.value].servers[0].url??null}let n=I.value;if(n>0&&r.servers&&!r.servers[n]&&(n=0),!r.servers||!r.servers[n])return"";if(r.servers[n].variables){const s=Object.values(r.servers[n].variables)??[];if(s&&s.length)return s[0].default}return r.servers[n].url??""});function N(n){I.value=n}function H(){var s;(((s=document.querySelector(".content-container"))==null?void 0:s.querySelectorAll("h1[id], h2[id], h3[id], h4[id]"))??[]).forEach(t=>{t.addEventListener("click",p=>{const j=t.getAttribute("id"),w=window.location.origin+window.location.pathname+"#"+j;f.copyToClipboard(w,p,!1),C.push({path:v.path,hash:"#"+j}),setTimeout(()=>{t.scrollIntoView({behavior:"smooth",block:"start"})},100)})})}function M(){if(v.hash)return;const n=document.querySelector(".oapi-content");n&&(n.scrollTop=0)}function T(){const n=JSON.stringify(r,null,4),s=new Blob([n],{type:"application/json"}),t=URL.createObjectURL(s),p=document.createElement("a");p.href=t,p.download=g.value+".json",document.body.appendChild(p),p.click(),document.body.removeChild(p),URL.revokeObjectURL(t)}return Z(()=>{y.$on("downloadJsonDoc",T),y.$on("changeServer",N),M(),H()}),ee(()=>{y.$off("downloadJsonDoc",T),y.$off("changeServer",N)}),(n,s)=>{const t=J,p=W,j=F,w=G,B=z,E=V,$=Y;return h(),ne("div",re,[e(D)&&e(c).info?(h(),m(t,{key:0,info:e(c).info,servers:e(c).servers,"current-locale":e(d)},null,8,["info","servers","current-locale"])):e(L)&&e(c).components?(h(),m(p,{key:1,components:e(c).components,"current-locale":e(d)},null,8,["components","current-locale"])):e(S)&&e(c).components?(h(),m(j,{key:2,components:e(c).components,"current-locale":e(d)},null,8,["components","current-locale"])):e(u)?(h(),m(w,{key:3,route:e(u),"current-locale":e(d),method:e(o),components:e(c).components,url:e(k),path_doc:e(_),file:e(g),server:e(A),"sub-params":e(U)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):e(i)?(h(),m(w,{key:4,route:e(i),"current-locale":e(d),method:e(o),components:e(c).components,url:e(k),path_doc:e(_),file:e(g),server:e(A),"sub-params":e(U)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):(h(),m(B,{key:5})),q($,null,{default:te(()=>[q(E,{"current-locale":e(d),doc:e(c),path:e(_),file:e(g)},null,8,["current-locale","doc","path","file"])]),_:1})])}}});export{ge as default};
