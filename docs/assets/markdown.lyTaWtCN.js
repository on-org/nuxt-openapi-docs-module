...
`}}}},tags:["other"]}}},tags:{}},se={class:"content-container"},fe=K({__name:"markdown",setup(ie){const g=Q(),D=Y(),{$openapidoc:v,$openapidocBus:b,$openapidocRef:_}=oe(),y=q(""),I=q(0),k=q(ae.path.toString()),l=q(s??{}),f=a(()=>"markdown"),r=a(()=>g.params.type.toString()),T=a(()=>(g.params.mathod??"default").toString()),L=a(()=>r.value==="info"),N=a(()=>r.value==="auth"),S=a(()=>r.value==="components"),p=a(()=>v.currentLocale());_.setComponents(s.components),_.setDefinitions(s.definitions),_.setDocPath(k.value),_.setFile(f.value);const i=a(()=>{const n={...s.paths};if(!n)return null;for(const o in n){let t=o.toString();if(t.startsWith("/")&&(t=t.substring(1)),t.endsWith("/")&&(t=t.substring(-1)),t=t.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),t===T.value)return y.value=o.toString(),n[o]??null}return null}),c=a(()=>{const n={...s.webhooks};if(!n)return null;for(const o in n){let t=o.toString();if(t.startsWith("/")&&(t=t.substring(1)),t.endsWith("/")&&(t=t.substring(-1)),t=t.replace(/[/\\.?+=&{}]/gumi,"_").replace(/__+/,"_"),t===T.value)return y.value=o.toString(),n[o][r.value]??null}return null}),d=a(()=>i.value?i.value[r.value]??null:null),C=a(()=>i.value?i.value.parameters??null:null),H=a(()=>{const n=v.currentLocale()??"";return L.value?"[markdown] - Info Docs":N.value?"[markdown] - Authorization":S.value?"[markdown] - Components Docs":d.value?"[markdown] - "+(d.value["x-summary-"+n.value]||d.value.summary||""):""}),O=a(()=>{const n=v.currentLocale()??"";return L.value?"[markdown] - Info Docs":N.value?"[markdown] - Authorization":S.value?"[markdown] - Components Docs":d.value&&(d.value["x-description-"+n.value]||d.value.description)||""});re({title:H.value,meta:[{name:"description",content:O.value}],htmlAttrs:{lang:p.value},bodyAttrs:{class:"oapi"}});const R=a(()=>{if(i.value){if(i.value.servers&&i.value.servers[0])return i.value.servers[0].url??null;if(i.value[r.value]&&i.value[r.value].servers&&i.value[r.value].servers[0])return i.value[r.value].servers[0].url??null}if(c.value){if(c.value.servers&&c.value.servers[0])return c.value.servers[0].url??null;if(c.value[r.value]&&c.value[r.value].servers&&c.value[r.value].servers[0])return c.value[r.value].servers[0].url??null}let n=I.value;if(n>0&&s.servers&&!s.servers[n]&&(n=0),!s.servers||!s.servers[n])return"";if(s.servers[n].variables){const o=Object.values(s.servers[n].variables)??[];if(o&&o.length)return o[0].default}return s.servers[n].url??""});function j(n){I.value=n}function F(){var o;(((o=document.querySelector(".content-container"))==null?void 0:o.querySelectorAll("h1[id], h2[id], h3[id], h4[id]"))??[]).forEach(t=>{t.addEventListener("click",u=>{const w=t.getAttribute("id"),x=window.location.origin+window.location.pathname+"#"+w;v.copyToClipboard(x,u,!1),D.push({path:g.path,hash:"#"+w}),setTimeout(()=>{t.scrollIntoView({behavior:"smooth",block:"start"})},100)})})}function M(){if(g.hash)return;const n=document.querySelector(".oapi-content");n&&(n.scrollTop=0)}function P(){const n=JSON.stringify(s,null,4),o=new Blob([n],{type:"application/json"}),t=URL.createObjectURL(o),u=document.createElement("a");u.href=t,u.download=f.value+".json",document.body.appendChild(u),u.click(),document.body.removeChild(u),URL.revokeObjectURL(t)}return Z(()=>{b.$on("downloadJsonDoc",P),b.$on("changeServer",j),M(),F()}),ee(()=>{b.$off("downloadJsonDoc",P),b.$off("changeServer",j)}),(n,o)=>{const t=B,u=z,w=E,x=W,U=X,J=V,$=G;return m(),te("div",se,[e(L)&&e(l).info?(m(),h(t,{key:0,info:e(l).info,servers:e(l).servers,"current-locale":e(p)},null,8,["info","servers","current-locale"])):e(N)&&e(l).components?(m(),h(u,{key:1,components:e(l).components,"current-locale":e(p)},null,8,["components","current-locale"])):e(S)&&e(l).components?(m(),h(w,{key:2,components:e(l).components,"current-locale":e(p)},null,8,["components","current-locale"])):e(d)?(m(),h(x,{key:3,route:e(d),"current-locale":e(p),method:e(r),components:e(l).components,url:e(y),path_doc:e(k),file:e(f),server:e(R),"sub-params":e(C)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):e(c)?(m(),h(x,{key:4,route:e(c),"current-locale":e(p),method:e(r),components:e(l).components,url:e(y),path_doc:e(k),file:e(f),server:e(R),"sub-params":e(C)},null,8,["route","current-locale","method","components","url","path_doc","file","server","sub-params"])):(m(),h(U,{key:5})),A($,null,{default:ne(()=>[A(J,{"current-locale":e(p),doc:e(l),path:e(k),file:e(f)},null,8,["current-locale","doc","path","file"])]),_:1})])}}});export{fe as default};
