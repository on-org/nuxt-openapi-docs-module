...
export async function getTexts(page: Page, selector: string, options?: Parameters<Page['locator']>[1]) {
  return await page.evaluate((selector: string) => document.querySelectorAll(selector) , selector);
}
