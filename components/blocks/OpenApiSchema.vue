<template>
  <div class="schema border border-gray-300 rounded p-5 mb-10">
    ...
    <div class="schema-row items-center" v-if="schema.additionalProperties && schema.additionalProperties.length">
