...
export default class BashSyntaxHighlighter extends SyntaxHighlighter {
  constructor() {
    const language: Language = {
      ...
      keywords: [
        ...
        'function', 'return', 'local', 'export', 'source', 'alias', 'unalias', 'break', 'continue',
        'shift', 'set', 'unset', 'test', 'chmod', 'chown', 'echo', 'cd', 'pwd', 'ls', 'cat', 'rm',
        'mv', 'cp', 'mkdir', 'rmdir', 'touch', 'ln', 'which', 'kill', 'ps', 'top', 'uptime', 'whoami',
        'man', 'help', 'history', 'jobs', 'fg', 'bg', 'nohup', 'wait', 'trap', 'exit', 'read',
        'printf', 'exec', 'time', 'sleep', 'tee', 'sudo'
      ],
      operators: [
        '&&', '||', ';', '&', '!', '(', ')', '{', '}', '[', ']'
      ],
