...
export default class OpenApiPlugin {
  ...
  logo: string | null = '<svg width="140" height="30" viewBox="0 0 380 91" class="css-1j8o68f">' +
    '<g id="SvgjsG1669" featurekey="PG4fjM-0" transform="matrix(0.3580488055912308,0,0,0.3580488055912308,0,0.00012395068781816175)" fill="#72AFF8">' +
    ...
    '</g>' +
    '<text x="50%" y="60%" dominant-baseline="middle" text-anchor="middle" fill="#72AFF8" font-size="56">:name</text>' +
    '</svg>';
